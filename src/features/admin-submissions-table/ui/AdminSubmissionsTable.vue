...
import { formatDate, truncateText, getStatusLabel, getStatusSeverity } from "../model/useAdminSubmissionsTable";
import type { AdminSubmissionsTableProps, AdminSubmissionsTableEmits, Submission } from "../model/types";

const props = defineProps<AdminSubmissionsTableProps>();
const emit = defineEmits<AdminSubmissionsTableEmits>();
