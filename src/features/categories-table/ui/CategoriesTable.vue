...
import { getCategoryColor } from "../model/useCategoriesTable";
import type { CategoriesTableProps, CategoriesTableEmits } from "../model/types";

const props = defineProps<CategoriesTableProps>();
