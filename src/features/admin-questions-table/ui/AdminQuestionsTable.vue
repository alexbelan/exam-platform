...
import { getTagStyles, formatDate } from "../model/useAdminQuestionsTable";
import type { AdminQuestionsTableProps, AdminQuestionsTableEmits } from "../model/types";

const props = defineProps<AdminQuestionsTableProps>();
const emit = defineEmits<AdminQuestionsTableEmits>();
