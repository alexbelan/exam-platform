...
import { getTagColor, getTagChipStyle } from "../model/useAdminTagsTable";
import type { AdminTagsTableProps, AdminTagsTableEmits } from "../model/types";

const props = defineProps<AdminTagsTableProps>();
const emit = defineEmits<AdminTagsTableEmits>();
