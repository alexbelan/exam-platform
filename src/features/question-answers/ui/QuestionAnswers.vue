...
import type { QuestionAnswersProps, QuestionAnswersEmits, QuestionAnswer } from "../model/types";

const props = defineProps<QuestionAnswersProps>();
const emit = defineEmits<QuestionAnswersEmits>();
...
const {
  ...
  toggleCorrectAnswer,
  removeAnswer,
} = useQuestionAnswers(questionAnswers, emit);
