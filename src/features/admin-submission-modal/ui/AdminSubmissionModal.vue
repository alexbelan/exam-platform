      ...
      <div class="submission-header">
        <div class="submission-info">
          ...
          <div class="submission-meta">
            ...
            <span
              ><strong>Email:</strong>
              {{ props.submission.user.email }}</span
            >
            <span
              ><strong>Дата:</strong>
...
import { formatDate, getStatusLabel, getStatusSeverity } from "@features/admin-submissions-table";
import type { AdminSubmissionModalProps, AdminSubmissionModalEmits } from "./model/types";

const props = defineProps<AdminSubmissionModalProps>();
const emit = defineEmits<AdminSubmissionModalEmits>();
