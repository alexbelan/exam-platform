...
import type { AdminTestModalProps, AdminTestModalEmits } from "../model/types";
import { useAdminTestModal } from "../model/useAdminTestModal";

const props = withDefaults(defineProps<AdminTestModalProps>(), {
  saving: false,
  tagsLoading: false,
  tagOptions: () => [],
  value: null,
...
const emit = defineEmits<AdminTestModalEmits>();
