...
import { useTagModal } from "../model/useTagModal";
import type { TagModalEmits, TagModalProps } from "../model/types";
...
const { form, isEditMode, save, close } = useTagModal(props, emit);
</script>
